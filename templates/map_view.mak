  ...
  <div id="window_left" class="col s12 m12 l8">
    ...
    <div id="main-map-id" class="main-map">
      ...
      <div class="map-floating-buttons" id="map-floating-buttons-main-map-id">
        ...
        <a class="btn-floating tooltipped btn-large button-collapse" data-position="top" data-tooltip="${_('Map Options')}" data-activates="slide-out-map-options-main-map-id">
          <i class="material-icons">map</i>
        </a>
        <a class="btn-floating tooltipped btn-large button-collapse" data-position="top" data-tooltip="${_('Add a Filter')}" data-activates="slide-out-filter">
    ...
    <li>
      ...
      <div class="collapsible-body">
        <form action="#" class="map-menu-form">
          <input class="input-top js-activity-layer-toggle" type="checkbox" id="activity-layer-toggle-main-map-id" checked="checked">
          <label class="text-primary-color" for="activity-layer-toggle-main-map-id" style="line-height: 22px; height: 22px;" id="map-deals-symbolization-main-map-id">
    ...
    <li>
      ...
      <div class="collapsible-body">
        <form action="#" class="map-base-layer-entries">
          <p>
            <input class="with-gap js-base-map-layers" name="map-base-layers-main-map-id" type="radio" id="satelliteMapOption-main-map-id" value="satelliteMap" checked="checked" />
            <label for="satelliteMapOption-main-map-id">${_('Google Earth satellite images')}</label>
          </p>
          <p>
            <input class="with-gap js-base-map-layers" name="map-base-layers-main-map-id" type="radio" id="esriSatelliteMapOption-main-map-id" value="esriSatellite" />
            <label for="esriSatelliteMapOption-main-map-id">${_('ESRI World Imagery')}</label>
          </p>
          <p>
            <input class="with-gap js-base-map-layers" name="map-base-layers-main-map-id" type="radio" id="terrainMapOption-main-map-id" value="terrainMap" />
            <label for="terrainMapOption-main-map-id">${_('Google Terrain Map')}</label>
          </p>
          <p>
            <input class="with-gap js-base-map-layers" name="map-base-layers-main-map-id" type="radio" id="streetMapOption-main-map-id" value="streetMap"/>
